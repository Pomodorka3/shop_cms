                ...
                <?php if(!empty($this->menu)):?>
                    <?php foreach ($this->menu as $table => $item):?>
                        ...
                        <div class="vg-element vg-half  vg-center">
                            <div>
                                <img src="<?=PATH.ADMIN_TEMPLATE?>img/<?= array_key_exists('img', $item) ? $item['img'] : 'pages.png'?>" alt="pages">
                            </div>
                        </div>
                        <div class="vg-element vg-half vg-center vg_hidden">
                            <span class="vg-text vg-firm-color5"><?=array_key_exists('name', $item) ? $item['name'] : $table?></span>
                        </div>
                    </a>
                    <?php endforeach;?>
                <?php endif;?>
